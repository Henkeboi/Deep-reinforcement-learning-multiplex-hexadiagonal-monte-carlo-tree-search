...
class BasicClientActor(BasicClientActorAbs):
    ...
    def __init__(self, IP_address=None, verbose=True):
        ...
        la = 0.1
        device = 'cpu'
        self.player = NeuralActor(hidden_layers, max_num_moves, la, device)
        self.player.load_model('player2')
    ...
    def handle_get_action(self, state):
        ...
        move = state_manager.convert_to_move(self.player.get_action(state_string))
        next_move = move
        #############################
        #
        #
